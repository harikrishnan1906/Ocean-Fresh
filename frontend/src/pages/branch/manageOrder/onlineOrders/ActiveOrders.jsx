  ...
  const activeOrders = useMemo(() => {
    return orders.filter(
      (ord) =>
        ...
        ord.orderStatus === "ready_for_takeaway",
    );
  }, [orders]);
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <div className="p-2 mb-3 bg-light rounded">
                    ...
                    <p className="mb-0 text-muted small">
                      <i className="fa-solid fa-location-dot"></i> {ord.address}
                    </p>
                  </div>
                      ...
                      <div className="d-grid gap-2">
                        {ord.orderType === "delivery" ? (
                          <Button
                            ...
                            onClick={() =>
                              updateStatus(ord._id, "out_for_delivery")
                            }
                          >
                            Out For Delivery
                          </Button>
                          ...
                          <Button
                            ...
                            onClick={() =>
                              updateStatus(ord._id, "ready_for_takeaway")
                            }
                    ...
                    {(ord.orderStatus === "out_for_delivery" ||
                      ...
                      <div className="d-grid gap-2">
                        <Button
                          ...
                          onClick={() => updateStatus(ord._id, "delivered")}
                          disabled={actionLoading === ord._id}
                        >
                          {actionLoading === ord._id ? (
                            <Spinner size="sm" />
